...
<div id="hero-image-wrap" style="position:relative; width:100%; line-height:0;">
  ...
  <div style="width:100%; background:#fff; padding:40px 10% 50px; box-sizing:border-box; font-family:'Inter',sans-serif; line-height:1.9; display:flex; flex-direction:column; align-items:center;">
    <p style="font-size:1.15rem; margin-bottom:1.5rem; color:#111; max-width:700px; text-align:justify;">
    ...
    <p style="font-size:1.15rem; margin:0; color:#111; max-width:700px; text-align:justify;">
      Scénario propose des ateliers pour apprendre à construire et décrypter les futurs énergétiques.
    </p>
  </div>
</div>
...
<style>
  ...
  @media (max-width: 768px) {
    ...
    #hero-image-wrap p { text-align: left !important; }
  }
</style>
...
(function() {
  ...
  function init() {
    ...
    // Colle l'image sous le bandeau : mesure le gap réel et corrige
    var gap = heroWrap.getBoundingClientRect().top - headerH;
    if (gap > 0) heroWrap.style.marginTop = '-' + gap + 'px';

    // Sur mobile : logo direct dans le header, pas d'animation
    ...
    startW = Math.min(260, window.innerWidth * 0.22);
...
<div style="max-width:860px; margin:0 auto 80px; padding:0 32px; font-family:'Inter',sans-serif; color:#111;">
  ...
  <h2 style="font-size:1.6rem; font-weight:700; margin:3rem 0 2rem;">En quoi consiste l'atelier ?</h2>

  <div style="display:flex; justify-content:center; margin-bottom:3rem; background:#fff; padding:16px; margin-left:-32px; margin-right:-32px;">
    <img src="{{ site.baseurl }}/assets/img/photo-atelier.jpg" alt="Atelier Scénario" style="width:80%; max-width:900px; display:block; border-radius:4px;">
  </div>

  <!-- Partie 1 -->
  <div style="display:flex; gap:3rem; align-items:center; margin-bottom:4rem; flex-wrap:wrap;">
    <div style="flex:1; min-width:220px;">
      <img src="{{ site.baseurl }}/assets/images/image1-env.png" alt="Mode de vie" style="width:100%; border-radius:6px; display:block;">
    </div>
    <div style="flex:2; min-width:260px;">
      ...
      <p style="font-size:1rem; line-height:1.75; color:#333;">
        Choisissez un environnement (ville, campagne, mer…) puis construisez votre mode de vie : habitat, mobilité, alimentation. Ces choix définissent votre demande en énergie, le point de départ de tout.
      </p>
    </div>
  </div>
  ...
  <div style="display:flex; gap:3rem; align-items:center; margin-bottom:4rem; flex-wrap:wrap;">
    <div style="flex:2; min-width:260px; order:1;">
      ...
      <p style="font-size:1rem; line-height:1.75; color:#333;">
        Composez votre mix de production (solaire, éolien, nucléaire, gaz…) pour couvrir la demande. Quatre indicateurs en temps réel : coût, CO₂, empreinte matières, souveraineté. Un mix instable oblige à des arbitrages douloureux.
      </p>
    </div>
    <div style="flex:1; min-width:220px; order:2;">
      <img src="{{ site.baseurl }}/assets/images/image2-energy.png" alt="Mix énergétique" style="width:100%; border-radius:6px; display:block;">
    </div>
  </div>
  ...
  <div style="display:flex; gap:3rem; align-items:center; margin-bottom:4rem; flex-wrap:wrap;">
    <div style="flex:1; min-width:220px;">
      <img src="{{ site.baseurl }}/assets/images/image3-world.png" alt="Ressources mondiales" style="width:100%; border-radius:6px; display:block;">
    </div>
    <div style="flex:2; min-width:260px;">
  ...
  <p style="font-size:0.95rem; color:#777; text-align:center;">
     L'atelier est actuellement en cours de test. Si le sujet vous intéresse, écrivez-nous :&nbsp;&nbsp;
